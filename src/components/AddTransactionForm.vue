...
<template>
    <div class="add-transaction-form">
        <div class="form-header">
            ...
            <p class="form-subtitle">Geben Sie die Details des Kauf oder Verkaufes ein</p>
        </div>

        <form @submit.prevent.stop="handleAddTransactionClicked" @reset.prevent.stop="clearForm" class="form">
            <div class="form-grid">
                <div class="form-group">
                    <label for="newTransactionName" class="label">Item Name</label>
                    <input type="text" v-model="newTransactionName" id="newTransactionName" class="input"
                        placeholder="z.B. AK-47 Redline" required />
                </div>

                <div class="form-group">
                    <label for="newTransactionAmount" class="label">Anzahl</label>
                    <input type="number" v-model="newTransactionAmount" id="newTransactionAmount" class="input"
                        placeholder="1" min="1" required />
                </div>

                <div class="form-group">
                    <label for="newTransactionPrice" class="label">Einzelpreis (€)</label>
                    <input type="number" v-model="newTransactionPrice" id="newTransactionPrice" class="input"
                        placeholder="0,00" step="0.01" min="0" required />
                </div>

                <div class="form-group">
                    <label for="newTransactionOrigin" class="label">Herkunft</label>
                    <select v-model="newTransactionOrigin" id="newTransactionOrigin" class="input" required>
                        <option value="">Herkunft wählen</option>
                        <option value="Steam Market">Steam Market</option>
                        <option value="Third Party">Drittanbieter</option>
                ...
                <div class="form-group">
                    ...
                    <input type="date" v-model="newTransactionDate" id="newTransactionDate" class="input" required />
                </div>
