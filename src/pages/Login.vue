            ...
            <form @submit.prevent="handleLogin" class="login-form">
                <div class="form-group">
                    ...
                    <input id="email" v-model="formData.email" type="email" class="form-input"
                        :class="{ 'error': errorMessage && !formData.email.trim() }" placeholder="Enter your email"
                        :disabled="isLoading" @keypress="handleKeyPress" />
                </div>
                ...
                <div class="form-group">
                    ...
                    <input id="password" v-model="formData.password" type="password" class="form-input"
                        ...
                        placeholder="Enter your password" :disabled="isLoading" @keypress="handleKeyPress" />
                </div>
